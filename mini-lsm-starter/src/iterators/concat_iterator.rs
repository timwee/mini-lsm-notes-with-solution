...
impl SstConcatIterator {
    // check that sstables are sorted and non-overlapping
    // This is a sanity check - doesn't go through all the values inside the sstable.
    // Only uses the first and last keys for the check.
    ...
    pub fn create_and_seek_to_key(sstables: Vec<Arc<SsTable>>, key: KeySlice) -> Result<Self> {
        ...
        // Find the index of the sstable that contains the key based on the first key of the sstable
